...
Moralis.initialize("5bNbXgWtI1n2ojzyoHYTuA4zBqr4ERpDTDZTjAEG");
Moralis.serverURL = "https://jghasgymndto.usemoralis.com:2053/server";
    ...
    <tr>
        ...
        <td>
            <button
                ...
                data-max="${(token.balance, token.decimals)}"
            >
                Swap
            </button>
        </td>
